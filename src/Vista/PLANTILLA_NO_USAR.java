 ...
 * @author chris
 */
public class PLANTILLA_NO_USAR extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PLANTILLA_NO_USAR.class.getName());

    /**
     * Creates new form PLANTILLA_NO_USAR
     */
    public PLANTILLA_NO_USAR() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new PLANTILLA_NO_USAR().setVisible(true));
    }
